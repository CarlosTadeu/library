...
import com.opussoftware.security.*;
import com.opussoftware.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .antMatchers("/api/loans/user").hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.LIBRARIAN, AuthoritiesConstants.USER)
            ...
            .antMatchers("/api/subjects/**").hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.LIBRARIAN)
